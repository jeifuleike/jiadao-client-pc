    ...
    <div class="container">
      ...
      <div class="pay-type">
        ...
        <div class="item">
          ...
          <a class="btn alipay" @click="visibleDialog = true" :href="`https://apipc-xiaotuxian-front.itheima.net/pay/aliPay?orderId=${$route.query.id}&redirect=${encodeURIComponent('http://www.corho.com:8080/#/pay/callback')}`" target="_blank"></a>
        </div>
        <div class="item">
          <p>支付方式</p>
